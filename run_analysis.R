...
# Step 03 - Merge the training and the test sets to create one data set
...
# Step 4 - Extract only measurements of mean and standard deviation for each measurement
